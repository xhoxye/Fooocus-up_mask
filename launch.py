...
def check_base_environment():
    ...
    if is_installed("sageattention"):
        ...
        update_pkgs = [('comfyui_frontend_package', '1.23.4'), ('comfyui_workflow_templates', '0.1.30'), ('transformers', '4.47.1'), ('bitsandbytes', '0.45.5'), ('accelerate', '1.6.0'), ('av', '14.2.0'), ('yarl', '1.18.0'), ('gguf', '0.14.0')]
